...
<div class="users index">
	...
	foreach ($users as $user):
		...
		<tr<?php echo $class; ?>>
			...
			<td class="actions">
				<?php echo $this->Html->link(__d('users', 'View'), array('controller' => 'app_users', 'action' => 'view', $user[$model]['slug'])); ?>
				<?php 
//					echo $this->Html->link(__d('users', 'Edit'), array('action' => 'edit', $user[$model]['id']));
					echo $this->Html->link(__d('users', 'Edit'), array('controller' => 'app_users', 'action' => 'edit'));
				?>
